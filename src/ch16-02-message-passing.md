...
<<< @/listings/ch16-fearless-concurrency/listing-16-06/src/main.rs

<span class="caption">示例 16-6: 创建一个信道，并将其两端赋值给 `tx` 和 `rx`</span>
...
<<< @/listings/ch16-fearless-concurrency/listing-16-07/src/main.rs
...
<span class="caption">示例 16-9: 在我们已经发送到信道中后，尝试使用 `val` 引用</span>
