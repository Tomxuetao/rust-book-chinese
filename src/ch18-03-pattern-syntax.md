...
<<< @/listings/ch18-patterns-and-matching/no-listing-01-literals/src/main.rs
...
<<< @/listings/ch18-patterns-and-matching/no-listing-02-multiple-patterns/src/main.rs
...
<<< @/listings/ch18-patterns-and-matching/no-listing-03-ranges/src/main.rs
...
<<< @/listings/ch18-patterns-and-matching/no-listing-04-ranges-of-char/src/main.rs
...
<<< @/listings/ch18-patterns-and-matching/listing-18-12/src/main.rs
...
<<< @/listings/ch18-patterns-and-matching/listing-18-13/src/main.rs
...
<<< @/listings/ch18-patterns-and-matching/no-listing-05-destructuring-structs-and-tuples/src/main.rs
...
<<< @/listings/ch18-patterns-and-matching/listing-18-20/src/main.rs
...
<<< @/listings/ch18-patterns-and-matching/listing-18-23/src/main.rs
...
<<< @/listings/ch18-patterns-and-matching/listing-18-24/src/main.rs
...
<<< @/listings/ch18-patterns-and-matching/listing-18-25/src/main.rs

<span class="caption">示例 18-25: 尝试以有歧义的方式运用 `..`</span>

如果编译上面的例子，会得到下面的错误：

<<< @/listings/ch18-patterns-and-matching/listing-18-25/output.txt
...
<<< @/listings/ch18-patterns-and-matching/listing-18-26/src/main.rs
...
<<< @/listings/ch18-patterns-and-matching/listing-18-28/src/main.rs
...
<<< @/listings/ch18-patterns-and-matching/listing-18-29/src/main.rs
