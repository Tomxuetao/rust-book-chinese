...
<<< @/listings/ch19-advanced-features/listing-19-01/src/main.rs
...
<<< @/listings/ch19-advanced-features/listing-19-02/src/main.rs
...
<<< @/listings/ch19-advanced-features/listing-19-03/src/main.rs
...
<<< @/listings/ch19-advanced-features/no-listing-01-unsafe-fn/src/main.rs

必须在一个单独的 `unsafe` 块中调用 `dangerous` 函数。如果尝试不使用 `unsafe` 块调用 `dangerous`，则会得到一个错误：

<<< @/listings/ch19-advanced-features/output-only-01-missing-unsafe/output.txt
...
<<< @/listings/ch19-advanced-features/listing-19-04/src/main.rs
...
<<< @/listings/ch19-advanced-features/listing-19-05/output.txt
...
<<< @/listings/ch19-advanced-features/listing-19-09/src/main.rs
...
<<< @/listings/ch19-advanced-features/listing-19-10/src/main.rs
...
<<< @/listings/ch19-advanced-features/listing-19-11/src/main.rs
...
[dangling-references]: ch04-02-references-and-borrowing.md#悬垂引用dangling-references
[differences-between-variables-and-constants]: ch03-01-variables-and-mutability.md#常量
[extensible-concurrency-with-the-sync-and-send-traits]:
ch16-04-extensible-concurrency-sync-and-send.md#使用-sync-和-send-trait-的可扩展并发
[the-slice-type]: ch04-03-slices.md#slice-类型
