...
<<< @/listings/ch19-advanced-features/listing-19-28/src/lib.rs
...
<<< @/listings/ch19-advanced-features/listing-19-30/src/main.rs
...
<<< @/listings/ch19-advanced-features/no-listing-20-impl-hellomacro-for-pancakes/hello_macro/src/lib.rs

现在有了一个包含函数的 trait 。此时，crate 用户可以实现该 trait 以达到其期望的功能，像这样：

<<< @/listings/ch19-advanced-features/no-listing-20-impl-hellomacro-for-pancakes/pancakes/src/main.rs
...
[decl]: #使用-macro-rules-的声明宏用于通用元编程
