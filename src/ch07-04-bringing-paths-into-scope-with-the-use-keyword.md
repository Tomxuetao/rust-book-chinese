...
<<< @/listings/ch07-managing-growing-projects/listing-07-14/src/main.rs
...
<<< @/listings/ch07-managing-growing-projects/listing-07-15/src/lib.rs
...
<<< @/listings/ch07-managing-growing-projects/listing-07-16/src/lib.rs
...
<<< @/listings/ch07-managing-growing-projects/no-listing-01-use-std-unnested/src/main.rs

相反，我们可以使用嵌套路径将相同的项在一行中引入作用域。这么做需要指定路径的相同部分，接着是两个冒号，接着是大括号中的各自不同的路径部分，如示例 7-18 所示。

<span class="filename">文件名: src/main.rs</span>

<<< @/listings/ch07-managing-growing-projects/listing-07-18/src/main.rs
...
<<< @/listings/ch07-managing-growing-projects/listing-07-19/src/lib.rs
...
<<< @/listings/ch07-managing-growing-projects/listing-07-20/src/lib.rs
...
[rand]: ch02-01-guessing-game-tutorial.md#生成一个随机数
[writing-tests]: ch11-01-writing-tests.md#如何编写测试
