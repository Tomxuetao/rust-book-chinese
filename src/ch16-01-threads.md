...
<<< @/listings/ch16-fearless-concurrency/listing-16-05/src/main.rs
...
<<< @/listings/ch16-fearless-concurrency/output-only-01-move-drop/output.txt
...
[capture]: ch13-01-closures.md#闭包会捕获其环境
